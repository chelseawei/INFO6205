    ...
    public <T, U> double repeat(int n, Supplier<T> supplier, Function<T, U> function, UnaryOperator<T> preFunction, Consumer<U> postFunction) {
        ...
        for(int i = 0; i < n; i++) {
            if(preFunction != null && postFunction == null) {
                T sup = supplier.get();
                T preSup =  preFunction.apply(sup);
                resume();
                function.apply(preSup);
//                pauseAndLap();
                lap();
                pause();
                ...
                T sup = supplier.get();
                resume();
                U postSup = function.apply(sup);
//                pauseAndLap();
                lap();
                pause();
                postFunction.accept(postSup);
            } else if(preFunction == null && postFunction == null) {
                T sup = supplier.get();
                resume();
                function.apply(sup);
//                pauseAndLap();
                ...
                T preSup = preFunction.apply(sup);
                resume();
                U postSup = function.apply(preSup);
//                pauseAndLap();
                lap();
                pause();
                postFunction.accept(postSup);
